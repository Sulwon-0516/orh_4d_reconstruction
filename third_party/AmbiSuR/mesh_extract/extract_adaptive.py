...
def render_sets(dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool,
    ...
    with torch.no_grad():
        ...
        max_depth = (radius * 2)
        voxel_size = (max_depth / 1536)
        sdf_trunc = 5.0 * voxel_size
    
        print(f"depth_trunc: {max_depth:.2f}, voxel_size: {voxel_size:.2f}, sdf_trunc: {sdf_trunc:.2f}")    
...
if __name__ == "__main__":
    ...
    render_sets(model.extract(args), args.iteration, pipeline.extract(args), args.skip_train, args.skip_test, None, None, args.num_cluster, args.use_depth_filter)