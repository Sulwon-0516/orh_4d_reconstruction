...
# orhsurf: PyTorch3D was imported here for exactly one function, and building it from source is
# the likeliest install failure on a stranger's cluster. orhsurf.quat is a drop-in replacement,
# proven against the real PyTorch3D in tests/test_quat.py. Set ORHSURF_USE_PYTORCH3D=1 to restore.
import os as _os
if _os.environ.get("ORHSURF_USE_PYTORCH3D", "0") == "1":
    from pytorch3d.transforms import quaternion_to_matrix
else:
    from orhsurf.quat import quaternion_to_matrix
