...
def build_parser() -> argparse.ArgumentParser:
    ...
    whole.add_argument("--simplify", nargs="?", const="1M,5M", default=None, help="create random 1M and 5M versions, preserving originals; optionally specify other budgets")
    whole.add_argument("--simplify-method", choices=("random", "normal-voxel", "stratified"), default="random")
    whole.add_argument("--simplify-only", action="store_true", help="create and verify 1M and 5M versions, then delete originals; --simplify can override budgets")
